    ...
    db = {
        async query(text, params) {
            try {
                ...
                const res = await pool.query(text, params); //send query to POSTGRESQL and waits until the db responds
                const duration = Date.now() - start; // how long the query took in milliseconds
                //print in console which query was executed, how long it took and how many rows were affected   
